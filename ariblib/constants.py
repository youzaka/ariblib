...
COMPONENT_TYPE = {
    0x01: {
        ...
        0x02: '映像480i(525i)、アスペクト比16:9 パンベクトパンベクトルあり',
        0x03: '映像480i(525i)、アスペクト比16:9 パンベクトパンベクトルなし',
        0x04: '映像480i(525i)、アスペクト比16:9',
        0x91: '映像2160p、アスペクト比4:3',
        0x92: '映像2160p、アスペクト比16:9 パンベクトパンベクトルあり',
        0x93: '映像2160p、アスペクト比16:9 パンベクトパンベクトルなし',
        0x94: '映像2160p、アスペクト比16:9',
        0xA1: '映像480p(525p)、アスペクト比4:3',
        0xA2: '映像480p(525p)、アスペクト比16:9 パンベクトパンベクトルあり',
        0xA3: '映像480p(525p)、アスペクト比16:9 パンベクトパンベクトルなし',
        0xA4: '映像480p(525p)、アスペクト比16:9',
        0xB1: '映像1080i(1125i)、アスペクト比4:3',
        0xB2: '映像1080i(1125i)、アスペクト比16:9 パンベクトパンベクトルあり',
        0xB3: '映像1080i(1125i)、アスペクト比16:9 パンベクトパンベクトルなし',
        0xB4: '映像1080i(1125i)、アスペクト比16:9',
        0xC1: '映像720p(750p)、アスペクト比4:3',
        0xC2: '映像720p(750p)、アスペクト比16:9 パンベクトパンベクトルあり',
        0xC3: '映像720p(750p)、アスペクト比16:9 パンベクトパンベクトルなし',
        0xC4: '映像720p(750p)、アスペクト比16:9',
        0xD1: '映像240p アスペクト比4:3',
        0xD2: '映像240p アスペクト比16:9 パンベクトパンベクトルあり',
        0xD3: '映像240p アスペクト比16:9 パンベクトパンベクトルなし',
        0xD4: '映像240p アスペクト比16:9',
        0xE1: '映像1080p(1125p)、アスペクト比4:3',
        0xE2: '映像1080p(1125p)、アスペクト比16:9 パンベクトパンベクトルあり',
        0xE3: '映像1080p(1125p)、アスペクト比16:9 パンベクトパンベクトルなし',
        0xE4: '映像1080p(1125p)、アスペクト比16:9',
        0xF1: '映像180p アスペクト比4:3',
        0xF2: '映像180p アスペクト比16:9 パンベクトパンベクトルあり',
        0xF3: '映像180p アスペクト比16:9 パンベクトパンベクトルなし',
